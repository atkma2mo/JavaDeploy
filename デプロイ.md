...
![無題のプレゼンテーション](https://user-images.githubusercontent.com/44164993/70643870-27ab7e80-1c85-11ea-9bca-d7afe3033a8a.png)
...
verboseで詳細なエラーで探すが目新しい情報がない。  
環境変数のexport classpath=の部分　profile.d/maven.sh  
ビルド用に仮想環境つくったりがみんな幸せ
検索欄に -mysqlとかでマイナス検索する。
